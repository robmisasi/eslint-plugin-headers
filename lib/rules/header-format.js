...
module.exports = {
  ...
  create(context) {
    ...
    const canApplyFix = headerFormatConfigOptions.patterns
      ? Object.keys(headerFormatConfigOptions.patterns).every(
          (patternName) =>
            headerFormatConfigOptions.patterns[patternName].defaultValue !==
            undefined,
        )
      : true;
    ...
    let variables = headerFormatConfigOptions.variables;
    if (variables) {
    ...
    const formatConfig = {
      blockPrefix:
        headerFormatConfigOptions.blockPrefix ?? defaultFormat.blockPrefix,
      blockSuffix:
        headerFormatConfigOptions.blockSuffix ?? defaultFormat.blockSuffix,
      linePrefix:
        headerFormatConfigOptions.linePrefix ?? defaultFormat.linePrefix,
      eol: sourceEol,
    };
