 ...
 */
function getFirstContentNode(context, headerComments) {
 ...
 * @returns Node
 */
function getMissingHeaderInsertionNode(program) {
    ...
    return {
      Program: function (node) {
        if (!hasHeaderComment(node, context)) {
          const missingHeaderInsertionPoint =
            getMissingHeaderInsertionNode(node);
          context.report({
        ...
        const firstContentNode = getFirstContentNode(context, headerComments);
