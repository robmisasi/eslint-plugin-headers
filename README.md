...
This project support Vue via the AST generated by the `vue-eslint-parser`
package. To properly apply rules from this plugin to Vue files, you must:

1. Install `vue-eslint-parser` as a dev dependency.
